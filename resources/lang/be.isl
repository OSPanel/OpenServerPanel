...
DiskStateError=Указаны каталог знаходзіцца на сціснутым NTFS-томе. Усталяванне немагчыма. Калі ласка, выберыце іншы каталог.
...
SubDataPacks=Дадатковыя наборы дадзеных
SubModules=Модулі