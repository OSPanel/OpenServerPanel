...
for %%V in (7.2 7.3 7.4 8.0 8.1 8.2 8.3 8.4) do (
    ...
    if exist "!TARGET1!" (
        ...
        copy /Y "%SOURCE%" "!TARGET1!\composer.json" >nul
        copy /Y "%SOURCE%" "!TARGET1!\keys.tags.pub" >nul
        copy /Y "%SOURCE%" "!TARGET1!\keys.dev.pub" >nul
    ) else (
    ...
    if exist "!TARGET2!" (
        ...
        copy /Y "%SOURCE%" "!TARGET1!\composer.json" >nul
        copy /Y "%SOURCE%" "!TARGET2!\keys.tags.pub" >nul
        copy /Y "%SOURCE%" "!TARGET2!\keys.dev.pub" >nul
    ) else (
