...
set "SOURCE3=..\resources\php_addons\auth.json"
set "SOURCE4=..\resources\php_addons\keys.tags.pub"
set "SOURCE5=..\resources\php_addons\keys.dev.pub"
...
for %%V in (7.2 7.3 7.4 8.0 8.1 8.2 8.3 8.4) do (
    ...
    if exist "!TARGET1!" (
        ...
        copy /Y "%SOURCE3%" "!TARGET1!\auth.json" >nul
        copy /Y "%SOURCE4%" "!TARGET1!\keys.tags.pub" >nul
        copy /Y "%SOURCE5%" "!TARGET1!\keys.dev.pub" >nul
    ) else (
    ...
    if exist "!TARGET2!" (
        ...
        copy /Y "%SOURCE3%" "!TARGET2!\auth.json" >nul
        copy /Y "%SOURCE4%" "!TARGET2!\keys.tags.pub" >nul
        copy /Y "%SOURCE5%" "!TARGET2!\keys.dev.pub" >nul
    ) else (
