...
- Преднастроенная среда окружения для каждого модуля (вплоть для входа в shell/cli одной командой)
- 100% стабильность работы без багов/зависаний и проблем с кодировками
- Полный контроль пользователя над любыми параметрами и возможность легко добавлять свои модули (конструктор)
