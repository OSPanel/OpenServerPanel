...
После запуска панели управления изучите справку по команде `sysprep` и выполните установку необходимых для работы Open Server Panel библиотек и настройку системы, после чего перезагрузите компьютер. Теперь программа готова к использованию, вы можете активировать необходимые модули. Не забудьте снять защиту с файла HOSTS (есть есть) в настройках вашего файрвола/антивируса и добавить программу + модули в исключения.
