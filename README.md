...
Перед началом использования программы не забудьте снять защиту (есть есть) с файла HOSTS в настройках вашего файрвола/антивируса, а также настроить необходимые исключения для исполняемых файлов.

После запуска панели управления изучите справку по команде `sysprep` и выполните установку необходимых для работы Open Server Panel библиотек и настройку системы, после чего перезагрузите компьютер. Теперь программа готова к использованию, вы можете активировать необходимые модули.
