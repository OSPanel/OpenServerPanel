...
| `api_domain` | Локальный домен API и веб-интерфейса. Если включено использование файла HOSTS, то веб-интерфейс будет доступен в браузере на указанном домене.<br>Если в браузере используется VPN/прокси, то в настройках VPN/прокси необходимо задать исключение для этого домена. |
| `api_ip` | IP-адрес API и веб-интерфейса. Если в браузере используется VPN/прокси, то в настройках VPN/прокси необходимо задать исключение для этого IP. |
