...
------------
На время тестов Beta-версии дистрибутив распространяется в виде самораспаковывающегося RAR-архива. Скачайте дистрибутив, распакуйте его в выбранный каталог (желательно в корень диска). Перед началом работы снимите защиту (есть есть) с файла HOSTS в настройках вашего файрвола/антивируса, а также настройте необходимые исключения для исполняемых файлов.
