...
"%~dp0openssl.exe" req -x509 -new -sha256 -key "%~dp0..\..\user\ssl\root\root.key" -days 3650 -out "%~dp0..\..\user\ssl\root\root.crt" -subj "/emailAddress=/C=EU/stateOrProvinceName=/O=Open Server Panel/CN=Open Server Panel"
