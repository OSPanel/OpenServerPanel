...
del /Q "%~dp0..\..\user\ssl\root\root.key"
del /Q "%~dp0..\..\user\ssl\root\root.crt"
...
"%~dp0openssl.exe" ecparam -genkey -name prime256v1 -out "%~dp0..\..\user\ssl\root\root.key"
"%~dp0openssl.exe" req -x509 -new -sha256 -key "%~dp0..\..\user\ssl\root\root.key" -days 3650 -out "%~dp0..\..\user\ssl\root\root.crt" -subj "/emailAddress=root@ospanel.local/C=EU/stateOrProvinceName=Local Network/O=Open Server Panel/CN=Open Server Panel Root CA"
