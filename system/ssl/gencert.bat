...
"%~dp0openssl.exe" x509 -req -SHA256 -extfile "%~dp0..\..\temp\%1_v3.txt" -days 3650 -extensions trust_cert -in "%~dp0..\..\user\ssl\modules\%1\cert.csr" -CA "%~dp0..\..\user\ssl\root\rootCA.crt" -CAkey "%~dp0..\..\user\ssl\root\rootCA.key" -out "%~dp0..\..\user\ssl\modules\%1\cert.crt"
