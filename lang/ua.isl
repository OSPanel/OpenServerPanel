...
CreateDesktopIcon=Створити ярлики на &Робочому столі (для всіх користувачів)
...
Msvcr=Встановити Microsoft Visual C++ 2005-2019 Redistributable Packages
Msvcrlite=Встановити DLLs RuntimePack Lite
...
Ssdopts=Оптимізувати Windows для роботи з SSD-дисками (перезавантаження)
...
Runexe=Запустити Open Server Panel
RunManual=Інструкція користувача
RunDonate=Підтримати проект
MSVC=Обов'язкові компоненти Microsoft
...
OsCoreComp=Панель управління
OsServer=Веб-сервери
OsWTools=Веб-додатки
OsNoSQL=NoSQL системи
OsSQL=СУБД
OsPrograms=Програми для веб-розробки
OsProgramsJcpicker=Just Color Picker — підбирач кольору
OsProgramsOpera=Opera — веб-оглядач (браузер)
OsProgramsBrightMaster=Bright Master — регулятор яскравості моніторів
OsProgramsSimplewall=Simplewall — файрвол (брандмауер)
OsProgramsSublime=Sublime Text — текстовий редактор
OsProgramsWinSCP=WinSCP — SFTP/SCP/FTP клиент
