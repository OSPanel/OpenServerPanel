...
AddToPathDesc=Добавить каталог с программой в переменную PATH
...
OsCoreComp=Панель управления и базовый набор компонентов
OsOther=Другие модули
OsNoSQL=NoSQL системы
OsSQL=СУБД
OsPrograms=Программы для веб-разработки
OsProgramsJcpicker=Just Color Picker — подборщик цвета
OsProgramsOpera=Opera — веб-обозреватель (браузер)
OsProgramsBrightMaster=Bright Master — регулятор яркости мониторов
OsProgramsSimplewall=Simplewall — файрвол (брандмауэр)
OsProgramsSublime=Sublime Text — текстовый редактор
